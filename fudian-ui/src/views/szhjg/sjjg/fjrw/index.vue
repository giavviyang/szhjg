<template>
  <div class="dashboard-editor-container">
    <el-row :gutter="6" style="height: 100%">
      ...
      <!--分件-->
      <el-dialog title="分件" :visible.sync="dialogFormVisibleSub" width="500px" :modal='false' :append-to-body="true"
                 :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true"
                 :before-close="subdivisionCancel" class="dialog-style dialog-basic fenjian">
