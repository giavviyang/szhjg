<template>
  <div class="content">
    ...
    <div>
      ...
      <span style="font-size: 14px;color: #7e7c7c;margin: 3px;">首次使用请先<a @click="download()" style="text-decoration: underline;">下载安装</a>插件，如已安装未正常显示请<a @click="showPlugin()" style="text-decoration: underline;">点此刷新</a></span>
...
export default {
  ...
  methods: {
    ...
    //插件下载
    download(){
      const url = "ghfile/Ctest.zip"; // 文件相对于 public 目录的路径
      const link = document.createElement("a");
      link.href = url;
      link.download = "Ctest.zip"; // 下载时的文件名（可选）
