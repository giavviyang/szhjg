    ...
    <el-row :gutter="6" style="height: 100%">
      ...
      <el-col :span="12" style="height: 100%">
        <div class="chart-wrapper">
          ...
          <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
              <el-button type="success" plain icon="el-icon-edit" size="mini" @click="batchUpdate" :disabled="multiple"
                         v-hasPermi="['szhjg:xmpcgl:pcgl:updataBatch']">修改</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="danger" plain icon="el-icon-delete" size="mini" @click="batchDelete" :disabled="multiple"
            ...
            <el-col :span="1.5">
              <el-button type="info" plain icon="el-icon-circle-check" size="mini" @click="batchComplete"
                         v-hasPermi="['szhjg:xmpcgl:pcgl:complete']" :disabled="multiple">完成
              </el-button>
            </el-col>
          </el-row>
          <!--批次表单信息-->
      ...
      <el-col :span="12" style="height: 100%">
        <div class="chart-wrapper">
          ...
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="taskAdd" :disabled="multiple"
                         v-hasPermi="['szhjg:xmpcgl:pcgl:addTask']">新增任务</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="success" plain icon="el-icon-edit" size="mini" @click="taskUpdate" :disabled="multiple"
                         v-hasPermi="['szhjg:xmpcgl:pcgl:updataTask']">修改</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button type="danger" plain icon="el-icon-delete" size="mini" @click="taskDelete" :disabled="multiple"
...
export default {
  ...
  data() {
    return {
      ...
      //批次表头
      frameColumns: [
        {label: '状态', prop: 'isfinished', width: '60' , formatter: function (row, column, cellValue) {
  ...
  methods: {
    ...
    frameSelectionChange(val) {
      ...
      if (this.framegridCheck.length == 1) {
        //判断完成项目无法操作案卷任务
        this.multiple = (this.framegridCheck[0].isfinished === "1" && this.framegridCheck.length === 1);
